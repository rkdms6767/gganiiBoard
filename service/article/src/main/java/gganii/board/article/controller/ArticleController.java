package gganii.board.article.controller;

import gganii.board.article.service.ArticleService;
...
public class ArticleController {
    ...
    public List<ArticleResponse> readAllInfiniteScroll(@RequestParam("boardId") Long boardId,
        ...
        return articleService.findAllInfiniteScroll(boardId, pageSize, lastArticleId);
    }
